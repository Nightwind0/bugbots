...
namespace Quadtree
{
    ...
    private:
		...
		typedef typename std::list<T>::iterator ObjectIterator;
 ...
 */
template <class T,unsigned int max_depth, class Scalar, int max_object_radius, bool delete_empty_nodes>
void Node<T,max_depth,Scalar,max_object_radius,delete_empty_nodes>::Add(const Circle &bounds,const T &t)
{
